    ...
    return BaseScaffold(
        ...
        BoxContainer(
          ...
          children: [
            ...
            10.height,
            const DateTimePicker(title: 'Select time',icon: Icons.timelapse,),
          ],
        )),
            20.height,
            Text('Notes',style:context.textTheme.bodyLarge),
            10.height,
            InputField(hint: 'Enter notes here',lines: 3,radius: 10,fillColor: AppColors.gray1,),

            30.height,
            PrimaryButton(
              text: 'Save appointment',
              onPress: () {
                context.pushReplace(SuccessScreen(callback: (){
                  context.pushRemoveUntil(const HomeNavigationScreen());
                }, title: 'Appointment saved',description: "Your appointment has been scheduled successfully",));
              },
            ),
            20.height,

...
class NonCitizensProfileScreen extends StatefulWidget {
  const NonCitizensProfileScreen({
    super.key,
  });

  @override
  State<NonCitizensProfileScreen> createState() => _NonCitizensProfileScreenState();
}

class _NonCitizensProfileScreenState extends State<NonCitizensProfileScreen> {
      ...
      return BlocBuilder<CitizenProfileCubit, CitizenProfileCubitState>(
        builder: (context, _state) {
          ...
          final officers = _state.careTeam
              ...
              .toList();
               final citizens = _state.careTeam
              .where((user) => user.accountType == AccountType.citizen)
              .toList();
              ...
              child: Column(
                children: [
                  ...
                  _buildSection(
                    ...
                    title: "Citizens",
                    users: citizens,
                    emptyMessage: "No citizens available.",
                  ),
                  20.height,

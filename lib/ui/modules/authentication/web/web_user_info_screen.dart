    ...
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is RegistrationSuccessFull) {
          ...
          if (state.data.accountType == AccountType.citizen || state.data.accountType==AccountType.reentry_orgs) {
                            ...
                            children: [
                              ...
                              PillSelector(
                                ...
                                onChange: (value) {
                                  ...
                                  accountType.value = AccountType.values[value];
                                },
                                wrap: true,
                              ),
                              15.height,
                              ...
                              InputField(
                                ...
                                validator:accountType.value==AccountType.reentry_orgs? InputValidators.stringValidation:null,
